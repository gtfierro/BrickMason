    ...
    def __init__(self, G, cfg):
        ...
        for pattern in meters:
            for meteruri in resolve_pattern(pattern, namespace=cfg['namespace']):
                ...
                if meter_name is not None:
                    ...
                    logging.warning("No meter name found for i.xbos.meter")
                    continue
                meter_name = 'meter_'+meter_name
                ...
                logging.info('meter name: {0}'.format(meter_name))
        ...
        for meteruri in meters:
            ...
            if meter_name is not None:
                ...
                logging.warning("No meter name found for i.meter")
                continue
            meter_name = 'meter_'+meter_name
